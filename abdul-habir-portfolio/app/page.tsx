    ...
    <div className={`min-h-screen ${themeBg} ${themeText} transition-colors duration-500 font-sans scroll-smooth`}>
      ...
      <section id="achievements" className="py-32 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid gap-6">
            <div className={`${cardBg} p-6 md:p-8 rounded-[2rem] border ${cardBorder} flex flex-col md:flex-row gap-6 items-start text-left shadow-xl`}>
      ...
      <section id="education" className="py-20 md:py-32 px-4 md:px-6 text-left">
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`${cardBg} p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] border ${cardBorder} shadow-2xl`}>
            <GraduationCap className={isDark ? 'text-[#0e1c47]' : 'text-blue-500'} size={40} />
            <h3 className="text-xl md:text-2xl font-bold mt-4 mb-1 italic">University of Mataram</h3>
      ...
      <section id="experience" className="py-20 md:py-32 px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid gap-6 md:gap-8">
            ...
            <div className={`${cardBg} p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] border ${cardBorder} relative overflow-hidden group shadow-2xl text-left`}>
              <Briefcase className="absolute -right-8 -top-8 text-white/5 group-hover:text-blue-500/10 transition-colors hidden lg:block" size={180} />
